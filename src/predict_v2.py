...
def rescale_image(img, max_side_len):
    ...
    resize_w = w
    resize_h = h
    #factor = min(float(h) / max_side_len, float(w) / max_side_len)
    factor = float(w) / max_side_len
...
def main():
    ...
    #weights_path = 'model/convnet_direction_227_weights_epoch07_loss0.0623.h5'
