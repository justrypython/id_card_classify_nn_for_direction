...
def main():
    ...
    image_path = '/home/share/model_share/box_5000_3900_down/3/'
    ...
    for i in os.listdir(image_path):
        ...
        fitted = False
        for factor in [3.0, 2.5, 2.0, 1.7, 1.3, 1.0, 0.7, 0.5, 0.3]:
            ...
            if result == 3:
                ...
                fitted = True
                down_shapes.append(newimg.shape[:2])
                break
        down_cnt += 1
        if fitted:
            down_rgt += 1
    ...
    for i in os.listdir(image_path):
        ...
        for factor in [3.0, 2.5, 2.0, 1.7, 1.3, 1.0, 0.7, 0.5, 0.3]:
            ...
            if result == 2:
                print(newimg.shape[:2])
                fitted = True
                right_shapes.append(newimg.shape[:2])
                break
        right_cnt += 1
        if fitted:
            right_rgt += 1
    ...
    for i in os.listdir(image_path):
        ...
        for factor in [3.0, 2.5, 2.0, 1.7, 1.3, 1.0, 0.7, 0.5, 0.3]:
            ...
            if result == 1:
                print(newimg.shape[:2])
                fitted = True
                up_shapes.append(newimg.shape[:2])
                break
        up_cnt += 1
        if fitted:
            up_rgt += 1
    ...
    for i in os.listdir(image_path):
        ...
        for factor in [3.0, 2.5, 2.0, 1.7, 1.3, 1.0, 0.7, 0.5, 0.3]:
            ...
            if result == 4:
                print(newimg.shape[:2])
                fitted = True
                left_shapes.append(newimg.shape[:2])
                break
        left_cnt += 1
        if fitted:
            left_rgt += 1
